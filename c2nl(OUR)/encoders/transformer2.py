...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward(self, inputs, mask,inputs2=None,mask2=None):
        ...
        context2, attn_per_head2, _ = self.attention2(inputs2, inputs2, context,
                                                   mask=mask2, attn_type="context")
        out = self.layer_norm2(self.dropout(context2) + context)

        return self.feed_forward(out), attn_per_head2
