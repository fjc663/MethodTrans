...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self,
        ...
        mid2, attn2, coverage2 = self.context_attn2(memory_bank2,
                                                ...
                                                attn_type="context",
                                                coverage=coverage)
        mid_norm2 = self.layer_norm_3(self.drop(mid2) + mid_norm)

#        mid, attn, coverage = self.context_attn(memory_bank2,
#                                                memory_bank2,
#                                                query_norm,
#                                                mask=src2_pad_mask,
#                                                attn_type="context",
...
#        mid_norm = self.layer_norm_2(self.drop(mid) + query_norm)
#
#        mid2, attn2, coverage2 = self.context_attn2(memory_bank,
#                                                    memory_bank,
#                                                    mid_norm,
#                                                    mask=src_pad_mask,
#                                                    layer_cache=layer_cache,
...
#        mid_norm2 = self.layer_norm_3(self.drop(mid2) + mid_norm)
        ...
        output = self.feed_forward(mid_norm2)
