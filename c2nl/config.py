...
def add_model_args(parser):
    ...
    data.add_argument('--max_src2_len', type=int, default=100,
                      help='Maximum allowed length for the source sequence 2')
    ...
    model.add_argument('--use_src2_char', type='bool', default=False,
                       help='Use character embedding in the source2')
    ...
    model.add_argument('--use_src2_word', type='bool', default=True,
                       help='Use word embedding in the input')
